...
if(isset($_POST['submit'])){
    ...
    $sql1 = "INSERT INTO rekapitulasi(tanggal, jenis, keluar) VALUES ('$tanggal','Keluar','$jumlah')";
    $sql2 = "INSERT INTO uang_keluar(keterangan, tanggal, jumlah) VALUES('$keterangan', '$tanggal', '$jumlah')" ;
    mysqli_query($conn, $sql1 ) or die(mysqli_error($conn));
    mysqli_query($conn, $sql2 ) or die(mysqli_error($conn));
    if($sql){
        echo '<script>alert("Berhasil menambahkan data."); document.location="../tampilan/uangkeluar.php";</script>';
    }else{
