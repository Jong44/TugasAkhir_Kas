...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 p-2">
            <br/>
            <h3><i class="fas fa-hand-holding-usd m-3"></i>KAS KELUAR</h3><hr>
            <a href="../db/tambahkeluar.php" class="btn btn-primary ps-1 pt-1"><i class="fas fa-plus-circle m-1"></i>Tambah Data Keluar</a>
            <br/>
            ...
            <br/>
                ...
                <tbody>
                <?php
				$sql = mysqli_query($conn, "SELECT * FROM uang_keluar") or die(mysqli_error($conn));
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>'.$data['tanggal'].'</td>
							<td>'.$data['jumlah'].'</td>
                            <td><a href="../db/delete2.php?keterangan='.$data['keterangan'].'"><i class="fas fa-minus-circle bg-danger p-1 text-white rounded"></a></i></td>
						</tr>
						';
						$id++;
					}
