...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 p-2">
            <br/>
            <h3><i class="fas fa-dollar-sign m-3"></i>UANG MASUK</h3><hr>
            <a href="../db/tambahmasuk.php" class="btn btn-primary ps-1 pt-1"><i class="fas fa-plus-circle m-1"></i>Tambah Data Masuk</a>
            <br/>
            ...
            <br/>
                ...
                <tbody>
                <?php
				$sql = mysqli_query($conn, "SELECT * FROM uang_masuk") or die(mysqli_error($conn));
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>'.$data['tanggal'].'</td>
							<td>'.$data['jumlah'].'</td>
                            <td><a href="../db/delete1.php?nama='.$data['nama'].'"><i class="fas fa-minus-circle bg-danger p-1 text-white rounded"></a></i></td>
						</tr>
						';
						$id++;
					}
